...
function init_gear_sets()
    ...
    sub="Niobid Strap",
    ammo="Impatiens",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+22','Magic burst mdg.+10%','MND+1','"Mag.Atk.Bns."+10',}},
    body="Shango Robe",
    ...
    sets.midcast['Death'] = {
    main={ name="Grioavolr", augments={'Magic burst mdg.+5%','MP+106','Mag. Acc.+17','"Mag.Atk.Bns."+17',}},
    sub="Niobid Strap",
    ammo="Ghastly Tathlum +1",
    head="Pixie Hairpin +1",
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+13 "Mag.Atk.Bns."+13','Magic burst mdg.+7%','Mag. Acc.+13','"Mag.Atk.Bns."+9',}},
    ...
    sets.midcast['Healing Magic'] = {main="Serenity",ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Telchine Gloves",ring1="Ephedra Ring",ring2="Ephedra Ring",
        back="Swith Cape",waist="Goading Belt",legs="Chironic Hose",feet="Academic's Loafers"}
    ...
    head="Befouled Crown",
    body="Vanya Robe",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','Mag. crit. hit dmg. +4%','Mag. Acc.+13','"Mag.Atk.Bns."+3',}},
    legs={ name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}},
    ...
    main={ name="Grioavolr", augments={'Enfb.mag. skill +10','MND+1','Mag. Acc.+12','"Mag.Atk.Bns."+23','Magic Damage +6',}},
    sub="Niobid Strap",
    ammo="Ghastly Tathlum +1",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','"Fast Cast"+6','INT+6','Mag. Acc.+4','"Mag.Atk.Bns."+14',}},
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Mag. crit. hit dmg. +2%','Mag. Acc.+15',}},
    hands={ name="Amalric Gages", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
    legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Magic burst dmg.+10%','MND+7','Mag. Acc.+9','"Mag.Atk.Bns."+11',}},
    feet={ name="Merlinic Crackows", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','Magic burst dmg.+5%','"Mag.Atk.Bns."+15',}},
    neck="Mizu. Kubikazari",
    waist="Hachirin-no-Obi",
    ...
    sets.midcast['Elemental Magic'].HighTierNuke.CMP = set_combine(sets.midcast['Elemental Magic'].HighTierNuke, {body="Spaekona's Coat",})
    ...
    right_ring={ name="Dark Ring", augments={'Magic dmg. taken -6%',}},
    back="Cheviot Cape",
}
...
-- Fast cast argument above this to prevent looping.
	...
	elseif spell.english == 'Aspir' or spell.english == 'Aspir II' or spell.english == 'Aspir III' and player.mp > 1510 then
		sets.midcast['Dark Magic'] = set_combine(sets.midcast['Dark Magic'], {
    main={ name="Grioavolr", augments={'Magic burst mdg.+5%','MP+106','Mag. Acc.+17','"Mag.Atk.Bns."+17',}},
    sub="Niobid Strap",
    ammo="Ghastly Tathlum +1",
