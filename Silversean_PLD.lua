...
function user_setup()
	state.DamageMode = M('Unlocked','Burtgang','Excalibur', 'Savage', 'Blunt', 'Aeolian','Lv.1 Dagger')
...
sets.engaged.EnmityRetention = {
    ...
    ammo="Vanir Battery",
    head="Null Masque",
    body={name="Adamantite Armor", priority=6},
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
    feet="Sakpata's Leggings",
    neck="Coatl Gorget +1",
...
--==================================================--
	...
	sets.midcast.Enhance = {ammo="Staunch Tathlum",
		head={ name="Souv. Schaller +1", augments={'HP+105','Enmity+9','Potency of "Cure" effect received +15%',}, priority=14},
		body={ name="Souv. Cuirass +1", augments={'HP+105','Enmity+9','Potency of "Cure" effect received +15%',}, priority=13}, 
		hands="Regal Gauntlets",
