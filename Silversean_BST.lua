...
function job_setup()
	...
	send_command("alias rewardset gs equip sets.precast.JA.Reward")
	send_command("alias readymab gs equip sets.midcast.Pet.MagicAtkReadyDWNE")
	send_command("alias readyatk gs equip sets.midcast.Pet.ReadyDWNE")
	send_command("alias readyacc gs equip sets.midcast.Pet.ReadyDWNE.HighAcc")
	select_default_macro_book()
	if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
		send_command('@wait 1;input /equip sub "Astolfo"')
	else
		send_command('@wait 1;input /equip sub "Adapa Shield"')
	end
	send_command('@wait 1;input /lockstyleset 8')
...
function user_setup()
    ...
    state.JugMode = M{['description']='Jug Mode', 'BlackbeardRandy', 'SwoopingZhivago', 'WarlikePatrick',
        'HeadbreakerKen', 'VivaciousVickie', 'BouncingBertha', 'ScissorlegXerin', 'ThreestarLynn', 'HeraldHenry', 'AlluringHoney','FaithfulFalcorr','ThreestarLynn'}
...
function init_gear_sets()
    ...
    Pet_PDT_feet = { name="Valorous Greaves", augments={'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: Phys. dmg. taken -3%','System: 1 ID: 1794 Val: 7',}}
    Pet_PDT_back = "Pastoralist's Mantle"

    Ready_Atk_head = "Emicho Coronet"
    Ready_Atk_body = { name="Valorous Mail", augments={'Pet: Attack+28 Pet: Rng.Atk.+28','Pet: "Dbl. Atk."+4','Pet: INT+2','Pet: Accuracy+11 Pet: Rng. Acc.+11',}}
    Ready_Atk_hands = "Nukumi Manoplas +1"
    Ready_Atk_legs = { name="Valor. Hose", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: Haste+1','System: 1 ID: 1792 Val: 7','Pet: Attack+14 Pet: Rng.Atk.+14',}}
    Ready_Atk_feet = { name="Valorous Greaves", augments={'Pet: Attack+28 Pet: Rng.Atk.+28','Pet: "Dbl. Atk."+2','Pet: Accuracy+14 Pet: Rng. Acc.+14',}}
    Ready_Atk_back = { name="Pastoralist's Mantle", augments={'STR+1 DEX+1','Accuracy+1','Pet: Accuracy+17 Pet: Rng. Acc.+17','Pet: Damage taken -3%',}}

    Ready_Acc_head = { name="Valorous Mask", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: STR+15','Pet: Attack+13 Pet: Rng.Atk.+13',}}
    Ready_Acc_body = Ready_Atk_Body
    Ready_Acc_hands = { name="Valorous Mitts", augments={'Pet: Accuracy+26 Pet: Rng. Acc.+26','System: 1 ID: 1792 Val: 2','Pet: Attack+14 Pet: Rng.Atk.+14',}}
    Ready_Acc_legs = Ready_Atk_Legs
    Ready_Acc_feet = { name="Valorous Greaves", augments={'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: Phys. dmg. taken -3%','System: 1 ID: 1794 Val: 7',}}
    Ready_Acc_back = Ready_Atk_back

    Ready_MAB_head = "Tali'ah Turban +1"
	-- Ready_MAB_head = { name="Valorous Mask", augments={'Pet: Mag. Acc.+30','System: 1 ID: 1792 Val: 9','Pet: Accuracy+13 Pet: Rng. Acc.+13','Pet: Attack+1 Pet: Rng.Atk.+1',}}
    Ready_MAB_body = { name="Valorous Mail", augments={'Pet: "Mag.Atk.Bns."+29','Pet: INT+10',}}
    --Ready_MAB_hands = { name="Valorous Mitts", augments={'Pet: "Mag.Atk.Bns."+28','Pet: "Regen"+2','Pet: INT+12',}}
	Ready_MAB_hands = "Nukumi Manoplas +1"
	Ready_MAB_legs = { name="Valor. Hose", augments={'Pet: "Mag.Atk.Bns."+25','Pet: "Dbl. Atk."+1','Pet: INT+10','Pet: Attack+5 Pet: Rng.Atk.+5',}}
    Ready_MAB_feet = { name="Valorous Greaves", augments={'Pet: "Mag.Atk.Bns."+29','"Dbl.Atk."+3','Pet: INT+10','Pet: Accuracy+4 Pet: Rng. Acc.+4','Pet: Attack+6 Pet: Rng.Atk.+6',}}

    Ready_MAcc_head = Ready_MAB_head
    Ready_MAcc_body = "Taeon Tabard"
    Ready_MAcc_hands = Ready_Atk_hands
    Ready_MAcc_legs = Ready_MAB_legs
    Ready_MAcc_feet = Ready_MAB_feet

    Ready_Atk_Axe = { name="Digirbalag", augments={'Pet: "Dbl. Atk."+4','Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: Attack+26 Pet: Rng.Atk.+26','DMG:+15',}}
    Ready_Acc_Axe = Ready_Atk_Axe
    Ready_MAB_Axe = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+25','Pet: Phys. dmg. taken -3%','Pet: TP Bonus+200',}}
    ...
    sets.midcast.FastRecast = {
        ...
        back="Repulse Mantle",waist="Incarnation Sash",
        legs=FC_legs,
        feet=FC_feet}
    ...
    sets.midcast.Cure = {ammo="Quartz Tathlum +1",
        ...
        body="Jumalik Mail",hands="Buremte Gloves",ring1="Leviathan Ring +1",ring2="Asklepian Ring",
        back=Pet_PDT_back,
        waist="Gishdubar Sash",legs="Ankusa Trousers +1",feet="Taeon Boots"}
    ...
    sets.midcast.Stoneskin = {ammo="Quartz Tathlum +1",
        ...
        back=Pet_PDT_back,
        waist="Engraved Belt",legs="Haven Hose",feet="Taeon Boots"}
    ...
    sets.midcast.Pet.ReadyNE = set_combine(sets.midcast.Pet.WS, {main="Arktoi"})
    sets.midcast.Pet.ReadyNE.MedAcc = set_combine(sets.midcast.Pet.WS, {main="Arktoi",
        -- ear2="Ferine Earring",
        body=Ready_Acc_body,
        legs=Ready_Acc_legs})
    ...
    sets.midcast.Pet.ReadyRecastDWNE = {main="Arktoi",sub="Charmer's Merlin",legs="Desultor Tassets"}
    ...
    sets.midcast.Pet.MagicAtkReadyDWNE = set_combine(sets.midcast.Pet.MagicAtkReadyNE, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+180',}}})
    sets.midcast.Pet.MagicAtkReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.MedAcc, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+180',}}})
    sets.midcast.Pet.MagicAtkReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.HighAcc, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+180',}}})
    ...
    sets.defense.MDT = set_combine(sets.defense.PDT, {ammo="Sihirik",
        head="Iuitl Headgear +1",neck="Loricate Torque +1",ear1="Sanare Earring",ear2="Etiolation Earring",
        body="Savas Jawshan",
...
function job_aftercast(spell, action, spellMap, eventArgs)
	--windower.add_to_chat(8,"Spell Name:"..spell.name)
    --spelldebug(spell)
    if player.equipment.main == 'Aymur' then
