...
function user_setup()
    state.OffenseMode:options('Normal','DTmeva','HybridDPS', 'ResistTank', 'InquartataTank', 'MP', 'Tanking', 'TankHP', 'Kalungav25', 'Xeviosov25')
    state.IdleMode:options('Normal','Meva','Tanking', 'ResistTank', 'MP', 'Refresh', 'Kalungav25', 'TankHP')
...
--==================================================--
    ...
    ammo="Staunch Tathlum +1",
    head="Fu. Bandeau +3",
    body={ name="Herculean Vest", augments={'Pet: INT+6','Pet: AGI+10','Phalanx +4','Accuracy+4 Attack+4','Mag. Acc.+13 "Mag.Atk.Bns."+13',}},
    hands={ name="Herculean Gloves", augments={'Accuracy+2','Pet: Accuracy+13 Pet: Rng. Acc.+13','Phalanx +4','Accuracy+3 Attack+3',}},
    legs={ name="Herculean Trousers", augments={'STR+4','Crit.hit rate+1','Phalanx +3','Accuracy+15 Attack+15',}},
    feet={ name="Herculean Boots", augments={'VIT+1','CHR+12','Phalanx +4','Accuracy+14 Attack+14','Mag. Acc.+5 "Mag.Atk.Bns."+5',}},
    neck={ name="Futhark Torque +2", augments={'Path: A',}},
    waist="Plat. Mog. Belt",
    left_ear="Eabani Earring",
...
function refreshWindow()
    ...
    -- if not state.textHideMode.value then
		...
		elseif state.ZoneRing.current == 'None' then
			...
			textinbox = textinbox .. textColor .. "\\cs(255, 0, 0)" .. "ParryHybrid (F7) : " .. "\\cs(255, 255, 255)" .. tostring(state.ParryHeal.current) .. textColorNewLine
